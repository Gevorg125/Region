                ...
                <?php if ($action === "update"): ?>
                    <?php foreach ($finalModel as $index => $item): ?>
                        ...
                        <div class="form_item col-lg-12">
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-4 col-xs-6">
                                <?= $form->field($finalModel[$index], "[gurdian][$index]relationship", ["labelOptions" => ["label" => "Ազգակցական կապ"]])->textInput(); ?>
                            </div>
                            <div class="col-lg-2 col-md-2 col-sm-4 col-xs-6">
                ...
                <?php else: ?>
                    <?php for ($index = 1; $index <= 2; $index++): ?>
                        <div class="form_item col-lg-12">
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-4 col-xs-6">
                                <?= $form->field($finalModel, "[gurdian][$index]relationship", ["labelOptions" => ["label" => "Ազգակցական կապ"]])->textInput(); ?>
                            </div>
                            <div class="col-lg-2 col-md-2 col-sm-4 col-xs-6">
...
<!--            </div>-->
            <div class="col-lg-1 col-md-1 col-sm-2 col-xs-6">
                <?= $form->field($model, 'ngbh')->textInput(['maxlength' => true]) ?>
            </div>
        </section>
        ...
        <section class="col-lg-12 child-current-info">
            ...
            <div class="col-lg-2 col-md-2 col-sm-4 col-xs-6">
                <?= $form->field($model, 'out_education')->textInput() ?>
            </div>
        </section>
        ...
        <section class="col-lg-12 child-current-info">
            ...
            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                <?= $form->field($model, 'send_region')->dropDownList(ArrayHelper::map(Region::find()->orderBy(['name'=>SORT_ASC])->all(), 'id', 'name'),['prompt' => 'Ընտրել․․․'])->label('region') ?>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
        ...
        <section class="col-lg-12 child-current-info">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                ...
                <?= $form->field($file, 'cv')->fileInput(['class' => 'btn btn-default'])->label('Ընտանիքի բնութագրիչը և բերման պատճառները'); ?>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <?= $form->field($file, 'bazmkh')->fileInput(['class' => 'btn btn-default'])->label('Այլ փաստաթղթեր'); ?>
